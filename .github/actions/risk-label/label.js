export default async function riskLabel({github, context, core}) {
  ...
  if (!hasRiskLabels) {
    core.notice('Risk labels (low-risk, medium-risk, high-risk) are not configured in this repo — skipping.');
    return;
  }
